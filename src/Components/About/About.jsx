...
import { easeInOut, motion, useScroll, AnimatePresence } from 'framer-motion'
      ...
      <div className={style.about}>
        <div className={style.intro}>
          ...
          >
            ...
            >Estou <span className='fff2'>a 1 ano</span> estudando e criando projetos em <span className='fff2'>FRONT-END</span> (alguns em FullStack) para poder me desenvolver profissionalmente e estar pronto para o mercado</motion.p>
            {/* <motion.p className={style.p3}
              initial={{ opacity: 0, y: 75 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{
                once: true,
            ...
            <div className={style.btnDiv}>
              <a href="src/PtCV/CVpt.pdf" target='_blank'>
            ...
            >
              ...
              <div className={style.flex}>
                ...
                <motion.p
                  ...
                  transition={{ duration: 0.3, delay: 0.4, type: 'spring', stiffness: 50 }}
                >CS2 motion.pra desestressar <span>"Ou não"</span></motion.p>
              </div>
              <div className={style.flex}>
